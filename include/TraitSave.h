...
namespace ST::TraitSave {
    ...
    inline constexpr std::size_t kHeaderSize = TraitRules::kTraitCount * 4 + 4;
    ...
    // Always writes every known bonus, so the record length is fixed per version.
